...
from repositories import FilmRepository, RatingAverageRepository, RatingRepository, UserRepository
from schemas import FilmRating, MessageCreateRating, RatingCreate, RatingResponse
from services import RatingAverageService, RatingService
